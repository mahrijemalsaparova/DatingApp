...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        //for bringing our Cloudinary Configuration--->Access it---------------
        ...
        {          // fotograf eklemeye çalışan kullanıcın tokenını kontrol edecez
            ...
            if (file.Length > 0)
            {                           //read our uploaded file into memory
                using (var stream = file.OpenReadStream())
                {// giving upload params to cloudinary
            ...
            // map photoForCreationDto to ---> Photo
